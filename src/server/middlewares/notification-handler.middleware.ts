...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'current_affairs.create': {
    roles: ['admin', 'examiner'],
    key: 'new-article-published',
    tenantPath: ['organization', 'user', 'current_affairs'],
    userPath: [],
  },
  'mcq.create': {
    roles: ['admin', 'examiner'],
    key: 'new-mcq-created',
    tenantPath: ['organization', 'user', 'mcq'],
    userPath: [],
  },
  'subjective_question.create': {
    roles: ['admin', 'examiner'],
    key: 'new-subjective-question-created',
    tenantPath: ['organization', 'user', 'subjective_question'],
    userPath: [],
  },
  'test_series.create': {
    roles: ['admin', 'content-creator'],
    key: 'new-test-series-created',
    tenantPath: ['organization', 'user', 'test_series'],
    userPath: [],
  },
  'comment.create': {
    roles: ['admin', 'content-creator', 'examiner'],
    key: 'customer-comment',
    tenantPath: [],
    userPath: [],
  },
  'saved_article.create': {
    roles: ['admin', 'content-creator'],
    key: 'customer-saved-article',
    tenantPath: [],
    userPath: [],
  },
  'test_schedule.create': { roles: ['admin', 'examiner'], key: 'customer-test-schedule', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['admin'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['admin', 'content-creator', 'examiner'];
