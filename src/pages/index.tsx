...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`UPSC Quiz`}</title>

        <meta
          name="description"
          content="Empower your competitive exam preparation with UPSC Quiz - a comprehensive platform for curated current affairs, engaging MCQs, and personalized test series. Elevate your learning experience, track your performance, and conquer your goals."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb258ZW58MHx8fHwxNjkzNDAxMzk4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your competitive exam preparation with UPSC Quiz - a comprehensive platform for curated current affairs, engaging MCQs, and personalized test series. Elevate your learning experience, track your performance, and conquer your goals.`}
            </Text>
            <Box
