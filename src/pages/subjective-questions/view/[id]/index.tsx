...
import { getSubjectiveQuestionById } from 'apiSdk/subjective-questions';
import { SubjectiveQuestionInterface } from 'interfaces/subjective-question';

function SubjectiveQuestionViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Subjective Question Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('subjective_question', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/subjective-questions/edit/${id}`} passHref legacyBehavior>
                    <Button
